...
_cachedRequest2.default = _cachedRequest2.default(_request2.default);
...
function GET(path, cb) {
  _cachedRequest2.default.setCacheDirectory(_config.PATHS.CACHE);
  // console.log(`### ${endpoint}${path}`);
  (0, _cachedRequest2.default)({ url: '' + endpoint + path, json: true, timeout: timeout }, function (err, res, body) {
